...
async function findAdoptionRequestsByOwner(userId = null) {
  const [rows] = await db.query(
    `SELECT
      ...
      u.region AS postulante_region,
      u.ciudad AS postulante_ciudad,
      u.comuna AS postulante_comuna,
      u.direccion AS postulante_direccion,
      u.numeracion AS postulante_numeracion,
      u.complemento_direccion AS postulante_complemento_direccion,
      s.mensaje,
      s.estado,
      s.motivo_estado,
      s.created_at,
